    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          {{-- <li><a a href="{{url('user/articale')}}" class="{{ Request::is('user/articale') ? ' active text-primary' : ' ' }}  nav-link ">المقالات</a></li>
          <li><a a href="{{url('user/games')}}" class="{{ Request::is('user/games') ? ' active text-primary' : ' ' }}  nav-link ">ألالعاب</a></li> --}}
          <li><a href="{{url('user/Rehabilitation_exercises')}}" class="{{ Request::is('user/Rehabilitation_exercises') ? ' active text-primary' : ' ' }}  nav-link  ">التدريبات التأهيليه</a></li>
